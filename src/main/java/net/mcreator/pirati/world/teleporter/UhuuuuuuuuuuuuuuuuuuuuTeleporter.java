...
public class UhuuuuuuuuuuuuuuuuuuuuTeleporter implements ITeleporter {
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("uhuuuuuuuuuuuuuuuuuuuu_portal", Vec3i::compareTo, 300);
	public static PoiType poi = null;

	@SubscribeEvent
	public static void registerPointOfInterest(RegistryEvent.Register<PoiType> event) {
		poi = new PoiType("uhuuuuuuuuuuuuuuuuuuuu_portal",
				Sets.newHashSet(ImmutableSet.copyOf(PiratiModBlocks.UHUUUUUUUUUUUUUUUUUUUU_PORTAL.getStateDefinition().getPossibleStates())), 0, 1)
						.setRegistryName("uhuuuuuuuuuuuuuuuuuuuu_portal");
	...
	public UhuuuuuuuuuuuuuuuuuuuuTeleporter(ServerLevel worldServer, BlockPos entityEnterPos) {
	...
	public Optional<BlockUtil.FoundRectangle> createPortal(BlockPos p_77667_, Direction.Axis p_77668_) {
		...
		BlockState blockstate = PiratiModBlocks.UHUUUUUUUUUUUUUUUUUUUU_PORTAL.defaultBlockState().setValue(NetherPortalBlock.AXIS, p_77668_);
	...
	private PortalInfo getPortalInfo(Entity entity, ServerLevel server) {
		...
		return this.getPortalRepositioner(entity, blockpos1).map(repositioner -> {
			...
			if (blockstate.hasProperty(BlockStateProperties.HORIZONTAL_AXIS)) {
				...
				vector3d = UhuuuuuuuuuuuuuuuuuuuuPortalShape.getRelativePosition(teleportationrepositioner$result, direction$axis, entity.position(),
						entity.getDimensions(entity.getPose()));
			} else {
				direction$axis = Direction.Axis.X;
				vector3d = new Vec3(0.5, 0, 0);
			}
			return UhuuuuuuuuuuuuuuuuuuuuPortalShape.createPortalInfo(server, repositioner, direction$axis, vector3d,
