...
import net.mcreator.pirati.world.features.KorablFeature;
...
public class PiratiModFeatures {
	private static final Map<Feature<?>, FeatureRegistration> REGISTRY = new HashMap<>();
	static {
		REGISTRY.put(KorablFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.SURFACE_STRUCTURES, KorablFeature.GENERATE_BIOMES,
				KorablFeature.CONFIGURED_FEATURE));
	}
